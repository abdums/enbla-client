...
// this
const PopularPlaceCard = ({title, restaurant_name, price, image}) => {
  return (
    <View>
        <View className="flex flex-row items-center mb-3 mt-3">
        <Image source={{uri: image}} className="w-[46px] h-[46px] bg-[#d9d9d9] rounded-md mr-4"/>
        <View className="">
        ...
        <View className="absolute right-1 flex items-center justify-center w-[70px] h-[28px] rounded-lg bg-[#c8c8c8]">
            <Text className="text-center font-bold">ETB {price}</Text>
        </View>
        </View>

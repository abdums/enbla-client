  ...
  return (
    <View>
      ...
      <View className="mt-4">
        <SuggestedCard
          image={
            "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSir2NSfxLHAfXyfJpJM9rVDqPAVTQFYBvi1g&usqp=CAU"
          }
          title={"Doro Wot"}
          restaurant_name={"Yod Abyssinia"}
          price={4.99}
        />
        <SuggestedCard
          image={
          ...
          title={"Tibis Firfir"}
          restaurant_name={"Beletu Retsuarant"}
          price={4.99}
        />
        <SuggestedCard
          image={

...
// this
const Subtotal = ({ subtotal, discount, shipping_fee, total, items }) => {
  return (
    <View>
      ...
      <View className="space-y-2">
        ...
        <View className="justify-between flex flex-row">
          <Text className="font-normal text-sm text-left text-gray-400">
            Subtotal
          </Text>
          <Text className="font-bold text-sm text-left text-gray-600">
            {subtotal}
          </Text>
        </View>
        <View>
        ...
        <View>
          ...
          <View className="justify-between flex flex-row align-bottom">
            ...
            <View className="items-center space-x-1 flex flex-row">
              ...
              <Text className="font-bold text-2xl text-left"> ETB {total}</Text>
            </View>
          </View>
        </View>
      </View>

  ...
  return (
    <>
      <ScrollView className="bg-white min-h-screen ">
        ...
        <Image
          source={require("../assets/enblalanding.png")}
        ...
        <SafeAreaView className="px-4 relative bottom-16 pb-[200px]">
          <View
            className="items-end flex flex-row justify-between relative
          space-x-6  "
          >
            {/* Profile Picture */}
            <View
            ...
            >
              ...
              <View className="absolute bottom-0 right-0 bg-white rounded-full "></View>
            </View>
          </View>
          <View className="relative top-2 flex flex-row items-start">
            <View>
              <Text className="text-3xl font-medium text-left mr-4">
                {title}
              </Text>
              <Text className="text-sm font-medium text-gray-500 text-left">
                {description}
              </Text>
              <Text className="text-xl font-medium text-gray-500 text-left mt-2">
                {address}
              </Text>
            </View>
            <View

      ...
      <SafeAreaView className="pb-[200px]">
        ...
        <TouchableOpacity className="flex flex-row items-center ">
          <Image
            ...
            className="w-20 h-20 bg-[#d9d9d9] rounded-full mr-5"
          />
          <View>
            <Text className="font-medium text-lg text-left">
              {firstName + " " + lastName}
            </Text>
            <Text className="text-sm font-normal text-left text-gray-400">
              {phone}
            </Text>
          </View>
        ...
        <View className="border-y border-gray-300/80 mt-4 pt-3 pb-4">
          <TouchableOpacity>
            <Text className="text-left text-xl font-medium">{email}</Text>
          </TouchableOpacity>
        </View>
        {/* Css Note:  Border Bottom only  */}
        <View className="border-b border-gray-300/80 pt-3 pb-4">
          <TouchableOpacity>
            <Text className="text-left text-xl font-medium">{address}</Text>
          </TouchableOpacity>
        </View>

        <View className="border-b border-gray-300/80 pt-3 pb-4">
          <TouchableOpacity>
            <Text className="text-left text-xl font-medium">Notification</Text>
          </TouchableOpacity>
        </View>

        <View className="border-b border-gray-300/80 pt-3 pb-4">
          <TouchableOpacity>
            <Text className="text-left text-xl font-medium">Language</Text>
          </TouchableOpacity>
        </View>

        <View className="border-b border-gray-300/80 pt-3 pb-4">
          <TouchableOpacity>
            <Text className="text-left text-xl font-medium">Settings</Text>
          </TouchableOpacity>
        </View>
        ...
        <View className="border-b border-gray-300/80 pt-3 pb-4">
          <TouchableOpacity className="">
            <Text className="text-left text-xl font-medium">Support</Text>
          </TouchableOpacity>
        </View>

...
// import { AdjustmentsIcon, SearchIcon as SearchIconOutline} from 'react-native-heroicons/outline'
import SuggestedResults from "../components/SuggestedResults";
import DiscoverCard from "../components/DiscoverCard";

const SearchScreen = () => {
  return (
    <ScrollView className="bg-white min-h-screen pt-16 px-4 ">
      <SafeAreaView className="">
        ...
        <View className="">
          <DiscoverCard title={"Habesha Foods"} />
          <DiscoverCard title={"Fast Foods"} />
          <DiscoverCard title={"Doro wot"} />
        </View>
        {/* Suggested Meals */}

...
{/* Sample Data linking to Restaurant  */}
  ...
  {/* Price */}
          <View className="flex flex-row justify-between">
            <View className="flex flex-row items-center space-x-4">
              ...
              <Text className="text-lg flex-bold text-gray-600 line-through ">ETB 13.00</Text>
            </View>
  ...
  {/* Frequently Bought Together */}
          <View className="mt-9">
            ...
            <View className="mb-2">
{/* this */}
              <AddOn title={"Shuro"} price={"ETB 70"} />
              <AddOn title={"Firfir"} price={"ETB 100"} />
              <AddOn title={"Burger"} price={"ETB 200"} />
              <AddOn title={"Sga firfir"} price={"ETB 255"} />
